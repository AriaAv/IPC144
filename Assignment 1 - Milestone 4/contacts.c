...
void getAddress(struct Contact *p){
	...
	(*p).address.streetNumber = (char)getInt();
	...
	if (choice == 1) {
		...
		(*p).address.apartmentNumber = (char)getInt();
	}
...
void getNumbers(struct Contact *p){
	...
	*p->numbers.cell = (char)getInt();
	printf("Do you want to enter a home phone number? (y or n): ");
	choice = yes();
	if (choice == 1) {
		printf("Please enter the contact's home phone number: ");
		*p->numbers.home = (char)getInt();
	}
	printf("Do you want to enter a business phone number? (y or n): ");
	choice = yes();
	if (choice == 1) {
		printf("Please enter the contact's business phone number: ");
		*p->numbers.business = (char)getInt();
	}
}
